...
<p>
  ...
  **Ответ: 2**
  ...
  Так как свойство `color` у элемента `p` не задано, то оно будет унаследовано от родительского элемента. То есть значение будет равно `green`.
...
<p>
  ...
  **Ответ: 4**
  ...
  Порядок написания классов в атрибуте элемента значения не имеет.
