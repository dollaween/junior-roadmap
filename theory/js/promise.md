...
Соответственно:
- Когда в промисе будет вызван колбэк `resolve`, то состояние промиса изменится на `fulfilled`.
- Когда в промисе будет вызван колбэк `reject`, то состояние промиса изменится на `rejected`.
